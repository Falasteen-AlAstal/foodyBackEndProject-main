...
<div class="sidebar pe-4 pb-3">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('food-categories.index')}}" class="nav-item nav-link "><i class="fas fa-fw fa-folder me-2"></i>Categories</a>
                   
                    <a href="{{route('meals.index')}}" class="nav-item nav-link"><i class="fas fa-utensils me-2"></i>Food</a>
                    <a href="{{route('products.index')}}" class="nav-item nav-link"><i class="fa fa-archive me-2"></i>Products</a>
