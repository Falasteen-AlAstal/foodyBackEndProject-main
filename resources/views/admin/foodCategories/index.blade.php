...
@section('content')
 ...
 <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-6">
                    <div>
                        <a href="{{route('food-categories.create')}}"class="btn-primary btn-sm">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <a href="{{route('food-categories.edit')}}" class="btn-primary btn btn-sm mr-2"><i class="fas fa-edit"></i></a>
